...
| 30 | 00787ef9 | fix(docs): correct link formatting for Claude API sponsorship in README | ✅ done |
| 31 | 87c091e2 | fix(docs): correct formatting and wording for Claude API sponsorship in README files | ⚠️ picked (conflict: README_CN.md/README_JA.md deleted on custom, kept deleted via git rm; applied README.md portion) |
| 32 | ac21758e | feat(docs): add Code0 sponsorship information to README files in English, Chinese, and Japanese | ⚠️ picked (conflict: README_CN.md/README_JA.md deleted on custom, kept deleted via git rm; applied README.md change; added assets/code0.png) |
| 33 | f8334be8 | docs(README): update VisionCoder URLs in all language versions | ⚠️ picked (conflict: README_CN.md/README_JA.md deleted on custom, kept deleted via git rm; applied README.md portion) |
| 34 | 9e9c2442 | Merge pull request #4095 from router-for-me/readme-add | ⚠️ picked (merge: README.md auto-merged; conflict README_CN.md/README_JA.md deleted on custom, kept deleted via git rm; empty diff after resolution — created empty commit with original message + author) |
| 35 | 5afc0f1d | fix(translator): remove temperature parameter handling in Claude request transformations | ⚠️ picked (conflict: claude_executor rename applied as real integration; claude/gemini translator files modify/delete kept removed via git rm; claude/openai/chat-completions change applied) |
