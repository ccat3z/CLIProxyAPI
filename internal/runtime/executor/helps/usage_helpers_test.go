...
func TestParseOpenAIUsageIncludesCacheWriteTokens(t *testing.T) {
	data := []byte(`{"service_tier":"priority","usage":{"input_tokens":100,"output_tokens":20,"total_tokens":120,"input_tokens_details":{"cached_tokens":30,"cache_write_tokens":40}}}`)
	detail := ParseOpenAIUsage(data)
