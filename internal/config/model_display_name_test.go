...
`
	const jsonConfig = `{"claude-api-key":[{"models":[{"name":"claude-upstream","alias":"claude-alias","display-name":"Claude Name"}]}],"openai-compatibility":[{"name":"compat-provider","base-url":"https://example.com","models":[{"name":"compat-upstream","alias":"compat-alias","display-name":"Compatibility Name"}]}]}`
