...
- **Based on upstream commit**: `36b45d57a3e804b9dfcee307e5d7b3e8cea5acfc`
...
- [Removed: proxy-url Config and HTTP(S)/SOCKS Proxy Support](./removed-proxy-url.md) — `proxy-url` config field and all outbound HTTP(S)/SOCKS proxy infrastructure
